...
export const CRON_DAEMON_OWNER_KIND_ENV = 'OPCBRAIN_CRON_DAEMON_OWNER_KIND';
export const CRON_DAEMON_OWNER_TOKEN_ENV = 'OPCBRAIN_CRON_DAEMON_OWNER_TOKEN';
export const CRON_DAEMON_OWNER_PROCESS_PID_ENV = 'OPCBRAIN_CRON_DAEMON_OWNER_PROCESS_PID';
